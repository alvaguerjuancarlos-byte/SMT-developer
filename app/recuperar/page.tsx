    ...
    <div className="min-h-screen bg-[#0C0F0E] flex items-center justify-center px-4">
      <div className="w-full max-w-[400px]">
        ...
        <div className="bg-white rounded-2xl border border-[#E2E8E4] shadow-sm p-8">
          <h2 className="text-[18px] font-bold text-[#111d17] mb-1">Recuperar contraseña</h2>
          <p className="text-[13px] text-[#9aab9f] mb-6">
            Escribe tu correo y te mandamos un enlace para poner una contraseña nueva.
          </p>

          {enviado ? (
            <div className="bg-[#E1F5EE] border border-[#BEE8D8] rounded-xl px-4 py-3.5">
